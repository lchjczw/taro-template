    ...
    return () => (
      ...
      >
        <App.Body>
          ...
          <Space fill wrap direction="vertical">
            <Alert message="标题" type="normal" banner />
            <Alert message="标题" type="warning" banner />
            <Alert message="标题" type="info" banner />
            <Alert message="标题" type="success" banner />
            <Alert message="标题" type="error" banner />
          </Space>
